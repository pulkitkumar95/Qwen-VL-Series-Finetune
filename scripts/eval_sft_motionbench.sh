...
OUTPUT_DIR="output/test_train_1fps_h200_2"

# Training data paths (same as training script)
EVAL_PATH="/fs/vulcan-projects/motion_llm/pulkit/dataset_utils/final_jsons/motionbench_llava_style_v1.json"
IMAGE_FOLDER="/fs/vulcan-projects/motion_llm/datasets/MotionBench/MotionBench/all_vids"
